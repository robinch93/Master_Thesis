...
public class UnitConverterAppium5Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Weight']");
		...
		MobileElement element3 = driver.findElementByXPath("//android.widget.TextView[@text='gram']");

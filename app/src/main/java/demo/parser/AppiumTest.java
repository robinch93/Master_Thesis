...
public class AppiumTest {
	...
	private static void test000_prova() throws InterruptedException {
		...
		try {
			...
			AndroidDriver<MobileElement> driver = new AndroidDriver<MobileElement>(
					new URL("http://0.0.0.0:4723/wd/hub"), desiredCapabilities);
	...
	private static void test1_personewrong() throws InterruptedException {
		...
		try {
			...
			assertTrue(driver.findElement(By.xpath(
					"//div[contains(text(), 'Per favore, inserisci almeno tre caratteri per il nome/cognome.')]"))
					.isDisplayed());
	...
	private static void test2_personeright() throws InterruptedException {
		...
		try {
			...
			assertTrue(driver
					.findElement(By.xpath("//*[contains(text(), 'Dipartimento di Automatica e Informatica (DAUIN)')]"))
					.isDisplayed());
	...
	private static void test5_bibliotecasearchauthor() throws MalformedURLException, InterruptedException {
		...
		assertTrue(driver.findElement(By.xpath("//*[text()='Software engineering' and @class='titolo ng-binding']"))
				.isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'Addison- Wesley')]")).isDisplayed());
		assertTrue(
				driver.findElement(By.xpath("//*[text()='1995' and @class='anno ng-binding ng-scope']")).isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'Autore:')]")).isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[text()='Sommerville, Ian' and @class='ng-binding ng-scope']"))
				.isDisplayed());
	...
	private static void test6_bibliotecasearchtitleyear() throws InterruptedException, MalformedURLException {
		...
		assertTrue(driver
				.findElement(
						By.xpath("//*[text()=\"Perry's chemical engineers' handbook\" and @class='titolo ng-binding']"))
				.isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'McGraw-Hill Education')]")).isDisplayed());
		assertTrue(
				driver.findElement(By.xpath("//*[text()='2019' and @class='anno ng-binding ng-scope']")).isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'Autori:')]")).isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[text()='Green, Don W.' and @class='ng-binding ng-scope']"))
				.isDisplayed());
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'Formato:')]")).isDisplayed());
		assertTrue(
				driver.findElement(By.xpath("//*[contains(text(), '1 v. (varie sequenze) ; 26 cm')]")).isDisplayed());
	...
	private static void test7_notifiche() throws InterruptedException, MalformedURLException {
		...
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'Al momento non sono presenti messaggi.')]"))
				.isDisplayed());
	...
	private static void test10_libretto() throws InterruptedException, MalformedURLException {
		...
		assertTrue(
				driver.findElement(By.xpath("//*[contains(text(), 'Empirical methods in software')]")).isDisplayed());
	...
	private static void test11_logout() throws InterruptedException, MalformedURLException {
		...
		assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'Sei sicuro di voler effettuare il logout?')]"))
				.isDisplayed());
	...
	public static void test14_appelliesami() throws InterruptedException, MalformedURLException {
		...
		// SISTEMARE COME NEL TEST BIBLIOTECA (DOPPIO IDENTIFICATORE CLASSE+TEXT
		// PRECISO)
		// assertTrue(driver.findElement(By.xpath("//*[contains(text(), 'INVIA
		// PRESENZE')]")).isDisplayed());
	...
	public static void main(String[] args) throws Exception {
		...
		// AppiumServiceBuilder().usingPort(0).usingDriverExecutable(new File("path to
		// node")).withAppiumJS(new File("path to appium.js")));
		 ...
		 * try {
		 * //runtime.
		 * exec("cmd.exe /c start cmd.exe /k \"appium -a 0.0.0.0 -p 4723 --session-override -dc \"{\"\"noReset\"\": \"\"false\"\"}\"\""
		 * );
		 * //Thread.sleep(4000);
		 * driver = new AppiumDriverCustom<MobileElement>(new
		 ...
		 * caps.setCapability("udid", "emulator-5556"); //Give Device ID of your mobile
		 * phone
		...
		// try { test1_personewrong(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 1 failed"); }
		// try { test2_personeright(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 2 failed"); }
		// try { test3_contatti(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 3 failed"); }
		// try { test4_segnalaproblema(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 4 failed"); }
		// try { test5_bibliotecasearchauthor(); } catch (Exception e) {
		// e.printStackTrace(); System.out.println("test 5 failed"); }
		// try { test6_bibliotecasearchtitleyear(); } catch (Exception e) {
		// e.printStackTrace(); System.out.println("test 6 failed"); }
		// try { test7_notifiche(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 7 failed"); }
		// try { test8_studentlogin(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 8 failed"); }
		// try { test9_caricodidattico(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 9 failed"); }
		// try { test10_libretto(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 10 failed"); }
		// try { test11_logout(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 11 failed"); }
		// try { test12_loginteacher(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 12 failed"); }
		// try { test13_incarichi(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 13 failed"); }
		// try { test14_appelliesami(); } catch (Exception e) { e.printStackTrace();
		// System.out.println("test 14 failed"); }
		// try { test15_expandedsegnalaproblema(); } catch (Exception e) {
		// e.printStackTrace(); System.out.println("test 15 failed"); }

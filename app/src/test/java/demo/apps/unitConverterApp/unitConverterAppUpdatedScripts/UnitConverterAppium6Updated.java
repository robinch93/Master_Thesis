...
public class UnitConverterAppium6Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Cooking']");
		...
		MobileElement element3 = driver.findElementByXPath("//android.widget.TextView[@text='Gram - Euro']");
		...
		MobileElement element5 = driver.findElementByXPath("//*[contains(@text,'240.000')]");

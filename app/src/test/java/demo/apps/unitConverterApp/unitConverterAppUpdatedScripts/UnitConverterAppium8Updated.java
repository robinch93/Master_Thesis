...
public class UnitConverterAppium8Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element0 = driver.findElementByXPath("//android.widget.TextView[@text='Volume']");
		...
		Thread.sleep(200);
		MobileElement element2 = driver.findElementByXPath("//android.widget.TextView[@text='cubic meter']");
		...
		Thread.sleep(200);
		MobileElement element6 = driver.findElementByXPath("//*[contains(@text,'0.005')]");

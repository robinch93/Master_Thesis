...
public class UnitConverterAppium1Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(500);
		MobileElement element8 = driver.findElementByXPath("//*[contains(@text,'1 Pounds is equal to 14.5833 Ounces')]");
		AddScreenshot.elementScreenshot(driver, element8 , "element8");
		Assertions.assertTrue(driver.findElementByXPath("//*[contains(@text,'1 Pounds is equal to 14.5833 Ounces')]").isDisplayed());

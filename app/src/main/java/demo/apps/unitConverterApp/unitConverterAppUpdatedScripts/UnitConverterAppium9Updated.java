...
public class UnitConverterAppium9Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(1000);
		MobileElement element8 = driver.findElementByXPath("//*[contains(@text,'1 Celcius is equal to 33.8000 Fahrenheit')]");
		AddScreenshot.elementScreenshot(driver, element8 , "element8");
		Assertions.assertTrue(driver.findElementByXPath("//*[contains(@text,'1 Celcius is equal to 33.8000 Fahrenheit')]").isDisplayed());

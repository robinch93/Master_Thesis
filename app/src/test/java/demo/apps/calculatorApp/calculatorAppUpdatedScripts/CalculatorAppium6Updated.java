...
public class CalculatorAppium6Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException  {
		...
		Thread.sleep(200);
		MobileElement element2 = driver.findElementById("anubhav.calculatorapp:id/num4");
		...
		Thread.sleep(200);
		MobileElement element3 = driver.findElementById("anubhav.calculatorapp:id/sqrt");
		...
		AddScreenshot.elementScreenshot("CalculatorAppium6", driver, element4 , "element4");
		driver.findElementById("anubhav.calculatorapp:id/equal").click();

		
		Thread.sleep(200);
		MobileElement element5 = driver.findElementByXPath("//*[contains(@text,'2.0')]");
		AddScreenshot.elementScreenshot("CalculatorAppium6", driver, element5 , "element5");

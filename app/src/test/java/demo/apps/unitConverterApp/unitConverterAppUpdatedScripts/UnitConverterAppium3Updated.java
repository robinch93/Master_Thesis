...
public class UnitConverterAppium3Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element0 = driver.findElementByXPath("//android.widget.TextView[@text='Speed']");
		AddScreenshot.elementScreenshot("UnitConverterAppium3", driver, element0 , "element0");
		driver.findElementByXPath("//android.widget.TextView[@text='Speed']").click();
		...
		Thread.sleep(200);
		MobileElement element2 = driver.findElementByXPath("//android.widget.TextView[@text='meter/second']");
		AddScreenshot.elementScreenshot("UnitConverterAppium3", driver, element2 , "element2");
		driver.findElementByXPath("//android.widget.TextView[@text='meter/second']").click();
		...
		Thread.sleep(200);
		MobileElement element6 = driver.findElementByXPath("//*[contains(@text,'1.389')]");
		AddScreenshot.elementScreenshot("UnitConverterAppium3", driver, element6 , "element6");
		assertTrue(driver.findElementByXPath("//*[contains(@text,'1.389')]").isDisplayed());

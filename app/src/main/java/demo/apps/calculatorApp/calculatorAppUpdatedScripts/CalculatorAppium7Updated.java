...
public class CalculatorAppium7Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(200);
		MobileElement element2 = driver.findElementById("anubhav.calculatorapp:id/num2");
		AddScreenshot.elementScreenshot(driver, element2 , "element2");
		driver.findElementById("anubhav.calculatorapp:id/num2").click();


		Thread.sleep(200);
		MobileElement element3 = driver.findElementById("anubhav.calculatorapp:id/xpowy");
		...
		Thread.sleep(200);
		MobileElement element6 = driver.findElementByXPath("//*[contains(@text,'8.0')]");
		AddScreenshot.elementScreenshot(driver, element6 , "element6");
		Assertions.assertTrue(driver.findElementByXPath("//*[contains(@text,'8.0')]").isDisplayed());

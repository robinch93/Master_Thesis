...
public class UnitConverterAppium4Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Fuel']");
		...
		MobileElement element2 = driver.findElementById("com.androidapps.unitconverter:id/bt_simple_units_view");

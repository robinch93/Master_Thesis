...
public class UnitConverterAppium10Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Angle']");
		...
		MobileElement element3 = driver.findElementByXPath("//android.widget.TextView[@text='Minute']");
		...
		MobileElement element5 = driver.findElementByXPath("//*[contains(@text,'60.000')]");

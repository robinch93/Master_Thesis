...
public class CalculatorAppium8Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(200);
		MobileElement element2 = driver.findElementById("anubhav.calculatorapp:id/num1");
		...
		Thread.sleep(200);
		MobileElement element4 = driver.findElementById("anubhav.calculatorapp:id/log");
		...
		Assertions.assertTrue(driver.findElementByXPath("//*[contains(@text,'1.0')]").isDisplayed());

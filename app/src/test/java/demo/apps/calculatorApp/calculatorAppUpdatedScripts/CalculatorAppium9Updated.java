...
public class CalculatorAppium9Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element0 , "element0");
		driver.findElementById("com.google.android.calculator:id/collapse_expand").click();


		Thread.sleep(200);
		MobileElement element1 = driver.findElementById("com.google.android.calculator:id/fun_tan");
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element1 , "element1");
		driver.findElementById("com.google.android.calculator:id/fun_tan").click();


		Thread.sleep(200);
		MobileElement element2 = driver.findElementById("com.google.android.calculator:id/digit_4");
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element2 , "element2");
		driver.findElementById("com.google.android.calculator:id/digit_4").click();


		Thread.sleep(200);
		MobileElement element3 = driver.findElementById("com.google.android.calculator:id/digit_5");
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element3 , "element3");
		...
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element4 , "element4");
		...
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element5 , "element5");
		driver.findElementById("com.google.android.calculator:id/eq").click();


		Thread.sleep(200);
		MobileElement element6 = driver.findElementByXPath("//*[contains(@text,'1')]");
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element6 , "element6");

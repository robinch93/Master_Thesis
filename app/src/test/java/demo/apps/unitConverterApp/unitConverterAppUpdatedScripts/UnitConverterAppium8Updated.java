...
public class UnitConverterAppium8Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException  {
		...
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element0 , "element0");
		driver.findElementById("com.rcarvalho.unitconverter:id/spinnerCategory").click();


		Thread.sleep(1000);
		MobileElement element1 = driver.findElementByXPath("//*[contains(@text,'Speed')]");
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element1 , "element1");
		...
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element2 , "element2");
		...
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element3 , "element3");
		driver.findElementById("com.rcarvalho.unitconverter:id/spinnerUnitsBase").click();


		Thread.sleep(1000);
		MobileElement element4 = driver.findElementByXPath("//*[contains(@text,'knot')]");
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element4 , "element4");
		...
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element5 , "element5");
		driver.findElementById("com.rcarvalho.unitconverter:id/spinnerUnitsResult").click();


		Thread.sleep(1000);
		MobileElement element6 = driver.findElementByXPath("//*[contains(@text,'km/h')]");
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element6 , "element6");
		...
		AddScreenshot.elementScreenshot("UnitConverterAppium8", driver, element7 , "element7");

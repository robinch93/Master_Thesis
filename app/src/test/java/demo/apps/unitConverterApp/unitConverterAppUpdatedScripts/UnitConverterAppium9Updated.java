...
public class UnitConverterAppium9Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Temperature']");
		...
		MobileElement element3 = driver.findElementByXPath("//android.widget.TextView[@text='Kelvin']");

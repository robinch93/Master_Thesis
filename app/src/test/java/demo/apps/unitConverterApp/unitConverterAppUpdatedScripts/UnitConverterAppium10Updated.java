...
public class UnitConverterAppium10Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		MobileElement element8 = driver
				.findElementByXPath("//*[contains(@text,'1 Fahrenheit is equal to -17.2222 Celcius')]");
		AddScreenshot.elementScreenshot(driver, element8, "element8");
		assertTrue(driver.findElementByXPath("//*[contains(@text,'1 Fahrenheit is equal to -17.2222 Celcius')]")
				.isDisplayed());

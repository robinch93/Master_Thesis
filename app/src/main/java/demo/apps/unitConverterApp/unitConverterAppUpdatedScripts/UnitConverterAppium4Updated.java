...
public class UnitConverterAppium4Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(1000);
		MobileElement element8 = driver.findElementByXPath("//*[contains(@text,'1 Mile is equal to 0.0485 Kilometer')]");
		AddScreenshot.elementScreenshot(driver, element8 , "element8");
		Assertions.assertTrue(driver.findElementByXPath("//*[contains(@text,'1 Mile is equal to 0.0485 Kilometer')]").isDisplayed());

...
public class UnitConverterAppium3Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Speed']");
		...
		MobileElement element3 = driver.findElementByXPath("//android.widget.TextView[@text='meter/second']");

...
public class CalculatorAppium6Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementById("com.google.android.calculator:id/op_sqrt");
		...
		MobileElement element4 = driver.findElementByXPath("//*[contains(@text,'3')]");

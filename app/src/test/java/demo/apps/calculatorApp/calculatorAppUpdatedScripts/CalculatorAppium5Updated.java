...
public class CalculatorAppium5Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element2 = driver.findElementById("com.google.android.calculator:id/op_fact");
		...
		MobileElement element4 = driver.findElementByXPath("//*[contains(@text,'120')]");

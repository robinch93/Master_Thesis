...
public class CalculatorAppium7Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element2 = driver.findElementById("com.google.android.calculator:id/fun_log");
		...
		MobileElement element3 = driver.findElementById("com.google.android.calculator:id/digit_1");
		...
		AddScreenshot.elementScreenshot("CalculatorAppium7", driver, element7, "element7");

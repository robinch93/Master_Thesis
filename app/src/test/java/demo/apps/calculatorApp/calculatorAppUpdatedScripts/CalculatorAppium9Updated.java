...
public class CalculatorAppium9Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element2 = driver.findElementById("com.google.android.calculator:id/fun_tan");
		...
		MobileElement element4 = driver.findElementById("com.google.android.calculator:id/digit_5");
		...
		MobileElement element7 = driver.findElementByXPath("//*[contains(@text,'1')]");
		AddScreenshot.elementScreenshot("CalculatorAppium9", driver, element7, "element7");

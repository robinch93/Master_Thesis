...
public class UnitConverterAppium5Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		MobileElement element8 = driver
				.findElementByXPath("//*[contains(@text,'1 Liter is equal to 1000 Milliliter')]");
		AddScreenshot.elementScreenshot(driver, element8, "element8");
		assertTrue(
				driver.findElementByXPath("//*[contains(@text,'1 Liter is equal to 1000 Milliliter')]").isDisplayed());

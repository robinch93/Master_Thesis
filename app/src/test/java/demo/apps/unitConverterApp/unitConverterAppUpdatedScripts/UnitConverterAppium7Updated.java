...
public class UnitConverterAppium7Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element1 = driver.findElementByXPath("//android.widget.TextView[@text='Area']");
		...
		MobileElement element3 = driver.findElementByXPath("//android.widget.TextView[@text='Square kilometer']");

...
public class UnitConverterAppium8Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(1000);
		MobileElement element8 = driver.findElementByXPath("//*[contains(@text,'1 knot is equal to 1.8520 km/h')]");
		AddScreenshot.elementScreenshot(driver, element8 , "element8");
		Assertions.assertTrue(driver.findElementByXPath("//*[contains(@text,'1 knot is equal to 1.8520 km/h')]").isDisplayed());

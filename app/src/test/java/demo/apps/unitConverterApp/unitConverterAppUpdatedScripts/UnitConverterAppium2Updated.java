...
public class UnitConverterAppium2Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		MobileElement element8 = driver
				.findElementByXPath("//*[contains(@text,'1 Grains is equal to 0.0001 Kilograms')]");
		AddScreenshot.elementScreenshot(driver, element8, "element8");
		assertTrue(driver.findElementByXPath("//*[contains(@text,'1 Grains is equal to 0.0001 Kilograms')]")
				.isDisplayed());

...
public class UnitConverterAppium9Updated {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException {
		...
		MobileElement element0 = driver.findElementByXPath("//android.widget.TextView[@text='Temperature']");
		AddScreenshot.elementScreenshot("UnitConverterAppium9", driver, element0 , "element0");
		driver.findElementByXPath("//android.widget.TextView[@text='Temperature']").click();
		...
		Thread.sleep(200);
		MobileElement element2 = driver.findElementByXPath("//android.widget.TextView[@text='Kelvin']");
		AddScreenshot.elementScreenshot("UnitConverterAppium9", driver, element2 , "element2");
		driver.findElementByXPath("//android.widget.TextView[@text='Kelvin']").click();
		...
		driver.findElementById("com.androidapps.unitconverter:id/et_from_unit_val").sendKeys("4");


		Thread.sleep(200);
		MobileElement element6 = driver.findElementByXPath("//*[contains(@text,'277.150')]");
		AddScreenshot.elementScreenshot("UnitConverterAppium9", driver, element6 , "element6");
		assertTrue(driver.findElementByXPath("//*[contains(@text,'277.150')]").isDisplayed());
